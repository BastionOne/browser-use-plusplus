...
async def main():
    ...
    try:
        async with BrowserContextManager(
            ...
            browser_session = browserdata_list[0][0]
            print("Cookies for app.aikido.dev:")
            print(await browser_session.cookies(["https://app.aikido.dev"]))
            print("\nAll cookies via _cdp_get_cookies:")
            print(await browser_session._cdp_get_cookies())
