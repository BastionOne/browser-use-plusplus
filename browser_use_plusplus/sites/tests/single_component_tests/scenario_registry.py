...
SCENARIOS: List[Scenario] = [
    Scenario(
        ...
        module="browser_use_plusplus.sites.tests.single_component_tests.servers.scenario03_account_security_modal",
    ...
    Scenario(
        ...
        module="browser_use_plusplus.sites.tests.single_component_tests.servers.scenario04_integrations_modal",
    ...
    Scenario(
        ...
        module="browser_use_plusplus.sites.tests.single_component_tests.servers.scenario05_orders_table",
    ...
    Scenario(
        ...
        module="browser_use_plusplus.sites.tests.single_component_tests.servers.scenario06_reports_filters",
    ...
    Scenario(
        ...
        module="browser_use_plusplus.sites.tests.single_component_tests.servers.scenario07_nested_menus",
    ...
    Scenario(
        ...
        module="browser_use_plusplus.sites.tests.single_component_tests.servers.scenario09_project_wizard",
    ...
    Scenario(
        ...
        module="browser_use_plusplus.sites.tests.single_component_tests.servers.scenario10_incidents_modal",
    ...
    Scenario(
        ...
        module="browser_use_plusplus.sites.tests.single_component_tests.servers.scenario11_customer_drawer",
    ...
    Scenario(
        ...
        module="browser_use_plusplus.sites.tests.single_component_tests.servers.scenario12_hidden_admin",
