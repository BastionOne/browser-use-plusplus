...
#     _, _, browser = browser_data
#     page = await browser.new_page()
#     await page.goto("https://app.aikido.dev/settings/integrations/repositories")
...
async def main():
    ...
    AGENT_STEPS = 3
    with open("src/agent/discovery/sites/aikido/snapshots/aikido_settings_actions.json", "r") as f:
        data = json.load(f)
